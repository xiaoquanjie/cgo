...
void hook_accept_test() {
    ...
    server_addr.sin_port = htons(50052);  // �󶨵Ķ˿ں�
    server_addr.sin_addr.s_addr = INADDR_ANY;  // �������п��õ�����ӿ�
    if (bind(fd, (struct sockaddr*)&server_addr, sizeof(server_addr)) == -1) {
        print_withtime("bind error");
        return;
    }

    if (listen(fd, 10) == -1) {  // ������� 10 ����������ȴ�����
