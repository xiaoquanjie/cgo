...
std::shared_ptr<co_grpc::ClientStreamWriter<request, response, std::shared_ptr<::grpc::ClientAsyncWriter<request>>>>

#undef GRPC_SRV_READER
#define GRPC_SRV_READER(request, response) \
co_grpc::ServerStreamReader<request, response, ::grpc::ServerAsyncReader<response, request>>

#undef GRPC_CLIENT_READER
#define GRPC_CLIENT_READER(request, response) \
std::shared_ptr<co_grpc::ClientStreamReader<request, response, std::shared_ptr<::grpc::ClientAsyncReader<response>>>>

#undef GRPC_SRV_WRITER
#define GRPC_SRV_WRITER(request, response) \
co_grpc::ServerStreamWriter<request, response, ::grpc::ServerAsyncWriter<response>>

#undef GRPC_CLIENT_RW
#define GRPC_CLIENT_RW(request, response) \
std::shared_ptr<co_grpc::ClientStreamReaderWriter<request, response, std::shared_ptr<::grpc::ClientAsyncReaderWriter<request, response>>>>

#undef GRPC_SRV_RW
#define GRPC_SRV_RW(request, response) co_grpc::ServerStreamReaderWriter<request, response, ::grpc::ServerAsyncReaderWriter<response, request>>
